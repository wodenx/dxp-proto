...
import {
  ...
  ComponentOrTag, Div, H3, DesignableComponents, addClassesIf, as,
} from '@bodiless/fclasses';
import { asFluidToken } from '@bodiless/vital-elements';
import { lactaidTypography } from '../../components/Typography';
import { lactaidSpacing } from '../../components/Spacing';
...
const WithFourColumnGrid = asFluidToken({
  Layout: {
    Wrapper: 'grid lg:grid-cols-4 gap-y-5 lg:gap-1',
  },
});
